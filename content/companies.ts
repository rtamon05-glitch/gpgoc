...
export const COMPANIES: Company[] = [
  {
    ...
    accent: { color: '#c9a227', soft: '#f6ecd2', contrast: '#0b1f3a' },
    mood: 'light',
    nav: [
  ...
  },
  {
    ...
    status: 'planning',
    accent: { color: '#c9a227', soft: '#efe6d0', contrast: '#0b1f3a' },
    mood: 'dark',
    nav: [
  ...
  },
  {
    ...
    status: 'in-development',
    accent: { color: '#2f6fed', soft: '#e3ecfd', contrast: '#0b1f3a' },
    mood: 'light',
    nav: [
  ...
  },
  {
    ...
    status: 'in-development',
    accent: { color: '#c9a227', soft: '#f2e8cf', contrast: '#0b1f3a' },
    mood: 'light',
    nav: [
  ...
  },
  {
    ...
    status: 'planning',
    accent: { color: '#5c7a3d', soft: '#e8eddf', contrast: '#0b1f3a' },
    mood: 'light',
    nav: [
